...
// monitorDetailResponseEvaluationsModelInputContextJSON contains the JSON metadata
// for the struct [MonitorDetailResponseEvaluationsModelInputContext]
type monitorDetailResponseEvaluationsModelInputContextJSON struct {
...
func (r monitorDetailResponseEvaluationsModelInputContextJSON) RawJSON() string {
	return r.raw
}
