...
// DEEPRAILS_BASE_URL). This should be used to initialize new clients.
func DefaultClientOptions() []option.RequestOption {
	defaults := []option.RequestOption{option.WithEnvironmentV1()}
	if o, ok := os.LookupEnv("DEEPRAILS_BASE_URL"); ok {
...
// environment (DEEPRAILS_API_KEY, DEEPRAILS_BASE_URL). The option passed in as
