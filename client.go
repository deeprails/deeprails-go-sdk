...
// interacting with the deep rails API. You should not instantiate this client
...
func DefaultClientOptions() []option.RequestOption {
	...
	if o, ok := os.LookupEnv("DEEPRAILS_API_KEY"); ok {
		defaults = append(defaults, option.WithAPIKey(o))
	}
	if o, ok := os.LookupEnv("DEEP_RAILS_CUSTOM_HEADERS"); ok {
...
// environment (DEEPRAILS_API_KEY, DEEP_RAILS_BASE_URL). The option passed in as
