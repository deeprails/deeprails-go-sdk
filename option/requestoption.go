...
// RequestOption is an option for the requests made by the deep rails API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/deeprails/deeprails-go-sdk#readme-requestoptions
...
// WithEnvironmentV1 returns a RequestOption that sets the current
// environment to be the "v1" environment. An environment specifies which base URL
// to use by default.
func WithEnvironmentV1() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://api.deeprails.com/")
}
